...
namespace VardoneEntities.Entities
{
    public class PrivateMessage
    {
        ...
        protected bool Equals(PrivateMessage other) => MessageId == other.MessageId && Chat.Equals(other.Chat) && Author.Equals(other.Author) && CreateTime.Equals(other.CreateTime) && Text == other.Text && Base64Image == other.Base64Image;
        public override int GetHashCode() => HashCode.Combine(MessageId, Chat, Author, CreateTime, Text, Base64Image);
        public static bool operator ==(PrivateMessage left, PrivateMessage right) => left is not null && left.Equals(right);
        public static bool operator !=(PrivateMessage left, PrivateMessage right) => left is not null && !left.Equals(right);
    }
}