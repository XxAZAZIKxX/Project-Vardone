...
namespace VardoneEntities.Entities
{
    public class User
    {
        ...
        public override bool Equals(object secondUser) => secondUser is User user && Equals(user);
        private bool Equals(User other) => UserId == other.UserId && Username == other.Username && Email == other.Email && Base64Avatar == other.Base64Avatar && Description == other.Description;
